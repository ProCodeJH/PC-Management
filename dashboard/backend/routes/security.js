...
module.exports = function ({ db, io, exec, authenticateToken, requireRole }) {
    ...
    // GET /remote-ps/pcs/:ip/processes - WinRM remote (IP only, won't conflict with agent-based routes)
    router.get('/remote-ps/pcs/:ip/processes', authenticateToken, (req, res) => {
        const { ip } = req.params;
    ...
    // POST /remote-ps/pcs/:ip/kill-process - WinRM remote
    router.post('/remote-ps/pcs/:ip/kill-process', authenticateToken, requireRole('admin'), (req, res) => {
        const { ip } = req.params;
    ...
    // POST /remote-ps/pcs/send-file - UNC file transfer (WinRM)
    router.post('/remote-ps/pcs/send-file', authenticateToken, requireRole('admin'), (req, res) => {
    ...
    // POST /remote-ps/pcs/:ip/block-program - WinRM remote (registry-based)
    router.post('/remote-ps/pcs/:ip/block-program', authenticateToken, requireRole('admin'), (req, res) => {
        const { ip } = req.params;
    ...
    // GET /remote-ps/pcs/:ip/blocked-programs - WinRM remote (registry-based)
    router.get('/remote-ps/pcs/:ip/blocked-programs', authenticateToken, (req, res) => {
        const { ip } = req.params;
